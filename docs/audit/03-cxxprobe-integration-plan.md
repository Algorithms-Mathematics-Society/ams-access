...
Phase 1, and the Phase 2a Go protocol/persistence foundation have been
implemented in uncommitted working trees. Evidence and remaining gates are in
...
Phase 2 is not complete: quarantine/extraction, content-addressed publication,
transactional binding, and session/attempt snapshots remain. No judge or
desktop integration has shipped.
