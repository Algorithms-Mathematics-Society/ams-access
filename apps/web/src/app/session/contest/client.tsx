  ...
  return (
    ...
    >
      ...
      >
        ...
        {(() => {
          const bracketColor = faceStatus === "ok" ? "rgba(34,197,94,0.65)" : "rgba(245,158,11,0.65)";
          return (
            <>
              <div style={{ position: "absolute", top: "10px", left: "10px", width: "8px", height: "8px", borderTop: `1.5px solid ${bracketColor}`, borderLeft: `1.5px solid ${bracketColor}`, pointerEvents: "none" }} />
              <div style={{ position: "absolute", top: "10px", right: "10px", width: "8px", height: "8px", borderTop: `1.5px solid ${bracketColor}`, borderRight: `1.5px solid ${bracketColor}`, pointerEvents: "none" }} />
              <div style={{ position: "absolute", bottom: "10px", left: "10px", width: "8px", height: "8px", borderBottom: `1.5px solid ${bracketColor}`, borderLeft: `1.5px solid ${bracketColor}`, pointerEvents: "none" }} />
              <div style={{ position: "absolute", bottom: "10px", right: "10px", width: "8px", height: "8px", borderBottom: `1.5px solid ${bracketColor}`, borderRight: `1.5px solid ${bracketColor}`, pointerEvents: "none" }} />
            </>
          );
        })()}
        ...
        {cameraError && (
          ...
          >
            <p style={{ fontSize: "11px", color: "#fca5a5", textAlign: "center", lineHeight: 1.5, fontFamily: "inherit" }}>
              {cameraError}
            </p>
          </div>
        )}
